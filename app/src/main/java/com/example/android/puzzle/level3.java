...
public class level3 extends AppCompatActivity {
            ...
            public boolean onTouch (View v, MotionEvent ev) {
                ...
                switch (action) {
                    ...
                    case MotionEvent.ACTION_UP :
                        ...
                        // (3)
                        if (closeMatch (Color.parseColor("#000000"), touchColor, tolerance)) {
                            // Do the action associated with the RED region
                            nextImage = R.drawable.whereamilevel3;
                            chrono.stop();
                            showPopup1(level3.this,p,chrono);
                        } else {
                            //...
                        }
                        break;
    ...
    private void showPopup1(final Activity context, Point p, Chronometer chrono) {
        ...
        if((g.gettime(2)>comtim)||(g.gettime(2)==0)) {
            g.settime(comtim, 2);
        }
        popup.setContentView(layout);
        popup.setWidth(popupWidth);
