...
public class level11 extends AppCompatActivity {
            ...
            public boolean onTouch (View v, MotionEvent ev) {
                ...
                switch (action) {
                    ...
                    case MotionEvent.ACTION_UP :
                        ...
                        // (3)
                        if (closeMatch (Color.parseColor("#22B14C"), touchColor, tolerance)) {
                            // Do the action associated with the RED region
                            nextImage = R.drawable.whereamilevel11;
                            chrono.stop();
                            showPopup1(level11.this,p,chrono);
                        } else {
                            //...
                        }
                        break;
    ...
    private void showPopup(final Activity context, Point p) {
        ...
        View layout = layoutInflater.inflate(R.layout.popup11, viewGroup);
    ...
    private void showPopup1(final Activity context, Point p, Chronometer chrono) {
        ...
        if((g.gettime(10)>comtim)||(g.gettime(10)==0)) {
            g.settime(comtim, 10);
        }
        popup.setContentView(layout);
        popup.setWidth(popupWidth);
