...
public class level10 extends AppCompatActivity {
            ...
            public boolean onTouch (View v, MotionEvent ev) {
                ...
                switch (action) {
                    ...
                    case MotionEvent.ACTION_UP :
                        ...
                        // (3)
                        if (closeMatch (Color.parseColor("#FFAEC9"), touchColor, tolerance)) {
                            // Do the action associated with the RED region
                            nextImage = R.drawable.whereamilevel10;
                            chrono.stop();
                            showPopup1(level10.this,p,chrono);
                        } else {
                            //...
                        }
                        break;
    ...
    private void showPopup(final Activity context, Point p) {
        ...
        View layout = layoutInflater.inflate(R.layout.popup10, viewGroup);
    ...
    private void showPopup1(final Activity context, Point p, Chronometer chrono) {
        ...
        if((g.gettime(9)>comtim)||(g.gettime(9)==0)) {
            g.settime(comtim, 9);
        }
        popup.setContentView(layout);
        popup.setWidth(popupWidth);
