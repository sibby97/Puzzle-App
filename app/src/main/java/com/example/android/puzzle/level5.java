...
public class level5 extends AppCompatActivity {
            ...
            public boolean onTouch (View v, MotionEvent ev) {
                ...
                switch (action) {
                    ...
                    case MotionEvent.ACTION_UP :
                        ...
                        // (3)
                        if (closeMatch (Color.parseColor("#FFF200"), touchColor, tolerance)) {
                            // Do the action associated with the RED region
                            nextImage = R.drawable.whereamilevel5;
                            chrono.stop();
                            showPopup1(level5.this,p,chrono);
                        } else {
                            //...
                        }
                        break;
    ...
    private void showPopup(final Activity context, Point p) {
        ...
        View layout = layoutInflater.inflate(R.layout.popup5, viewGroup);
    ...
    private void showPopup1(final Activity context, Point p, Chronometer chrono) {
        ...
        if((g.gettime(4)>comtim)||(g.gettime(4)==0)) {
            g.settime(comtim, 4);
        }
        popup.setContentView(layout);
        popup.setWidth(popupWidth);
