...
public class level12 extends AppCompatActivity {
            ...
            public boolean onTouch (View v, MotionEvent ev) {
                ...
                switch (action) {
                    ...
                    case MotionEvent.ACTION_UP :
                        ...
                        // (3)
                        if (closeMatch (Color.parseColor("#B97A57"), touchColor, tolerance)) {
                            // Do the action associated with the RED region
                            nextImage = R.drawable.whereamilevel12;
                            chrono.stop();
                            showPopup1(level12.this,p,chrono);
                        } else {
                            //...
                        }
                        break;
    ...
    private void showPopup(final Activity context, Point p) {
        ...
        View layout = layoutInflater.inflate(R.layout.popup12, viewGroup);
    ...
    private void showPopup1(final Activity context, Point p, Chronometer chrono) {
        ...
        if((g.gettime(11)>comtim)||(g.gettime(11)==0)) {
            g.settime(comtim, 11);
        }
        popup.setContentView(layout);
        popup.setWidth(popupWidth);
