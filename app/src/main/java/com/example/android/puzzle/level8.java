...
public class level8 extends AppCompatActivity {
            ...
            public boolean onTouch (View v, MotionEvent ev) {
                ...
                switch (action) {
                    ...
                    case MotionEvent.ACTION_UP :
                        ...
                        // (3)
                        if (closeMatch (Color.parseColor("#FFC90E"), touchColor, tolerance)) {
                            // Do the action associated with the RED region
                            nextImage = R.drawable.whereamilevel8;
                            chrono.stop();
                            showPopup1(level8.this,p,chrono);
                        } else {
                            //...
                        }
                        break;
    ...
    private void showPopup(final Activity context, Point p) {
        ...
        View layout = layoutInflater.inflate(R.layout.popup8, viewGroup);
    ...
    private void showPopup1(final Activity context, Point p, Chronometer chrono) {
        ...
        if((g.gettime(7)>comtim)||(g.gettime(7)==0)) {
            g.settime(comtim, 7);
        }
        popup.setContentView(layout);
        popup.setWidth(popupWidth);
